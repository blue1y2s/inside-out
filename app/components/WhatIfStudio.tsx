...
export const WhatIfStudio: React.FC<WhatIfStudioProps> = ({ currentPosts, currentDimensions, targetPersona }) => {
  ...
  return (
    <div className="h-full flex flex-col text-neutral-charcoal">
      <div className="mb-6">
        <h2 className="text-3xl font-serif text-neutral-charcoal mb-2">Grafting Studio</h2>
        <p className="text-neutral-charcoal/60 text-sm">See how new thoughts reshape your inner landscape.</p>
      </div>

      <div className="flex-1 flex flex-col">
        <textarea
          className="w-full bg-white/40 border border-white p-6 text-lg text-neutral-charcoal mb-4 focus:border-emotion-anxiety outline-none resize-none rounded-xl h-40 placeholder-neutral-charcoal/40 font-serif shadow-inner"
        ...
        <button
          ...
          disabled={!draft}
          className="w-full py-3 bg-white border border-neutral-border text-neutral-charcoal font-bold rounded-xl hover:bg-emotion-joy hover:border-emotion-joy hover:text-white transition-all disabled:opacity-50 mb-6 shadow-sm"
        >
          Simulate Growth
        </button>
